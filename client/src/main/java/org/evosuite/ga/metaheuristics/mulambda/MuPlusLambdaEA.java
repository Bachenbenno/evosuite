 ...
 * @author José Campos
 */
public class MuPlusLambdaEA<T extends Chromosome, F extends FitnessFunction<T>> extends AbstractMuLambda<T, F> {
  ...
  protected void evolve() {
    ...
    for (int i = 0; i < this.population.size(); i++) {
      ...
      this.population.get(i).updateGeneration(this.currentIteration);
    }
